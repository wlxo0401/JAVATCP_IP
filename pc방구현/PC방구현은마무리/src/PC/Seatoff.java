...
public class Seatoff extends JPanel {
    ...
    public Seatoff(int numSeat) {
        ...
        for (int i = 0; i < 4; i++) {
            if (i == 0)
                label[i] = new JLabel((numSeat + 1) + ".빈자리");//로그인시 받아온 ID삽입
            else
                label[i] = new JLabel("");
    ...
    public static void main(String[] args) {
        ...
        frameTest.add(new Seatoff(1));
        frameTest.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frameTest.setSize(99, 146);
